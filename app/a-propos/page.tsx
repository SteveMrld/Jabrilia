    ...
    <div className="bg-paper">
      ...
      <section className="relative pt-36 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <h1 className="font-serif font-light text-paper leading-none" style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)' }}>
            Notre histoire
          </h1>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-paper">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-7">
            <h2
              className="font-serif font-light text-ink mb-10 leading-[1.2]"
            ...
            <div className="space-y-7 font-sans text-ink/55 leading-relaxed text-sm md:text-base">
              <p>
          ...
          <div className="lg:col-span-4 lg:col-start-9">
            <div className="border border-ink/15 p-8">
              <p className="font-sans text-[10px] tracking-[0.3em] uppercase text-gold mb-8">Nos valeurs</p>
              <div className="space-y-0">
                {[
                  ...
                  <div key={v.title} className={`py-7 ${i < 3 ? 'border-b border-ink/10' : ''}`}>
                    <h3 className="font-serif text-lg font-light text-ink mb-2">{v.title}</h3>
                    <p className="font-sans text-[11px] text-ink/40 leading-relaxed">{v.desc}</p>
                  </div>
                ))}
              </div>
            </div>
