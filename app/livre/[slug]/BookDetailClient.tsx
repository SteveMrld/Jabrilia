        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div ref={coverRef} className="lg:col-span-5 lg:sticky lg:top-28">
            <motion.div
              ...
              className="relative aspect-[3/4] max-w-xs mx-auto lg:mx-0 w-full overflow-hidden bg-[#F0EBE0] shadow-[0_32px_80px_rgba(0,0,0,0.18)] p-2"
            >
          ...
          <div ref={contentRef} className="lg:col-span-7 lg:pt-4 space-y-0">
            ...
            <p className="animate-item font-sans text-[11px] text-ink/25 leading-relaxed border-t border-border pt-6">
              Commande directe :{' '}
              <a href="mailto:contact@jabrilia.com" className="text-gold/60 hover:text-gold transition-colors">
